...
print(timeSurvivedP1);
var times = new Array(timeSurvivedP1, timeSurvivedP2, timeSurvivedP3, timeSurvivedP4);

times.Sort();
print(times);//All I did here was simply put the times in an array and use the prebuilt "sort" function to sort them from least to greatest
