...
function OnGUI () {
	if(GUI.Button(Rect(0,0, 50, 50), "Back"))
	{
		Application.LoadLevel("demoCharSelectScreen");
	}
 if (totalplayers >0) {
    GUI.Box (Rect (((Screen.width/totalplayers))-(Screen.width/(2 * totalplayers))-50,Screen.height - 100,100,100), "P1 Stats");
    GUI.Label (Rect (((Screen.width/totalplayers))-(Screen.width/(2 * totalplayers)),Screen.height - 80,100,100), p1stock);
	GUI.Label (Rect (((Screen.width/totalplayers))-(Screen.width/(2 * totalplayers))+30,Screen.height - 60,100,100), "x"+player1stock.ToString());
	GUI.Label (Rect (((Screen.width/totalplayers))-(Screen.width/(2 * totalplayers)),Screen.height - 45,100,100), player1percent.ToString()+"%");
...
if (totalplayers > 1) {
	...
	GUI.Label (Rect ((2*(Screen.width/totalplayers))-(Screen.width/(2 * totalplayers))+30,Screen.height - 60,100,100), "x"+player2stock.ToString());
	GUI.Label (Rect ((2*(Screen.width/totalplayers))-(Screen.width/(2 * totalplayers)),Screen.height - 60,100,100), player2percent.ToString()+"%");
...
if (totalplayers > 2) {
	...
	GUI.Label (Rect ((3*(Screen.width/totalplayers))-(Screen.width/(2 * totalplayers))+30,Screen.height - 60,100,100), "x"+player3stock.ToString());
	GUI.Label (Rect ((3*(Screen.width/totalplayers))-(Screen.width/(2 * totalplayers)),Screen.height - 60,100,100), player3percent.ToString()+"%");
...
if (totalplayers > 3) {
	...
	GUI.Label (Rect ((4*(Screen.width/totalplayers))-(Screen.width/(2 * totalplayers))+30,Screen.height - 60,100,100), "x"+player4stock.ToString());
	GUI.Label (Rect ((4*(Screen.width/totalplayers))-(Screen.width/(2 * totalplayers)),Screen.height - 60,100,100), player4percent.ToString()+"%");
